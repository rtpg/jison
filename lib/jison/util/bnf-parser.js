...
var bnf = (function(){var AST={ stack:[],
									shift: function(token) {this.stack.push({name:token,children:[]})},
reduce: function(token,number){var newToken={name:token,children:this.stack.slice(-number)};
								 								this.stack.splice(-number);this.stack.push(newToken)}};
						var rsymbols_={};
...
var $0 = $$.length - 1;
switch (yystate) {
case 1:AST.reduce('spec',5);
this.$ = $$[$0-4]; this.$[ebnf ? 'ebnf':'bnf'] = $$[$0-2]; return this.$;
break;
case 2:AST.reduce('spec',6);
this.$ = $$[$0-5]; this.$[ebnf ? 'ebnf':'bnf'] = $$[$0-3]; yy.addDeclaration(this.$,{include:$$[$0-1]}); return this.$;
break;
case 3:AST.reduce('optional_end_block',0);

break;
case 4:AST.reduce('optional_end_block',1);

break;
case 5:AST.reduce('declaration_list',2);
this.$ = $$[$0-1]; yy.addDeclaration(this.$, $$[$0]);
break;
case 6:AST.reduce('declaration_list',0);
this.$ = {};
break;
case 7:AST.reduce('declaration',2);
this.$ = {start: $$[$0]};
break;
case 8:AST.reduce('declaration',1);
this.$ = {lex: $$[$0]};
break;
case 9:AST.reduce('declaration',1);
this.$ = {operator: $$[$0]};
break;
case 10:AST.reduce('declaration',1);
this.$ = {include: $$[$0]};
break;
case 11:AST.reduce('operator',2);
this.$ = [$$[$0-1]]; this.$.push.apply(this.$, $$[$0]);
break;
case 12:AST.reduce('associativity',1);
this.$ = 'left';
break;
case 13:AST.reduce('associativity',1);
this.$ = 'right';
break;
case 14:AST.reduce('associativity',1);
this.$ = 'nonassoc';
break;
case 15:AST.reduce('token_list',2);
this.$ = $$[$0-1]; this.$.push($$[$0]);
break;
case 16:AST.reduce('token_list',1);
this.$ = [$$[$0]];
break;
case 17:AST.reduce('grammar',1);
this.$ = $$[$0];
break;
case 18:AST.reduce('production_list',2);
this.$ = $$[$0-1];
          if($$[$0][0] in this.$) this.$[$$[$0][0]] = this.$[$$[$0][0]].concat($$[$0][1]);
          else  this.$[$$[$0][0]] = $$[$0][1];
break;
case 19:AST.reduce('production_list',1);
this.$ = {}; this.$[$$[$0][0]] = $$[$0][1];
break;
case 20:AST.reduce('production',4);

		    $$[$0-1].forEach(function(handle_action){
		    			var numTokens=handle_action[0];
		    			handle_action.shift();
		    			//now to inject the code
		    			handle_action[1]='AST.reduce(\''+$$[$0-3]+'\','+numTokens+');\n'+handle_action[1];
		    });
        	this.$ = [$$[$0-3], $$[$0-1]];
        
break;
case 21:AST.reduce('handle_list',3);
this.$ = $$[$0-2]; this.$.push($$[$0]);
break;
case 22:AST.reduce('handle_list',1);
this.$ = [$$[$0]];
break;
case 23:AST.reduce('handle_action',3);

        	this.$ = [$$[$0-2].length,($$[$0-2].length ? $$[$0-2].join(' ') : '')];
            this.$.push($$[$0]?$$[$0]:'');
            if($$[$0-1]) this.$.push($$[$0-1]);
            if (this.$.length === 1) this.$ = this.$[0];
        
break;
case 24:AST.reduce('handle',2);
this.$ = $$[$0-1]; this.$.push($$[$0])
break;
case 25:AST.reduce('handle',0);
this.$ = [];
break;
case 26:AST.reduce('handle_sublist',3);
this.$ = $$[$0-2]; this.$.push($$[$0].join(' '));
break;
case 27:AST.reduce('handle_sublist',1);
this.$ = [$$[$0].join(' ')];
break;
case 28:AST.reduce('expression_suffix',2);
this.$ = $$[$0-1] + $$[$0]; 
break;
case 29:AST.reduce('expression',1);
this.$ = $$[$0]; 
break;
case 30:AST.reduce('expression',1);
this.$ = ebnf ? "'"+$$[$0]+"'" : $$[$0]; 
break;
case 31:AST.reduce('expression',3);
this.$ = '(' + $$[$0-1].join(' | ') + ')'; 
break;
case 32:AST.reduce('suffix',0);
this.$ = ''
break;
case 33:AST.reduce('suffix',1);

break;
case 34:AST.reduce('suffix',1);

break;
case 35:AST.reduce('suffix',1);

break;
case 36:AST.reduce('prec',2);
this.$ = {prec: $$[$0]};
break;
case 37:AST.reduce('prec',0);
this.$ = null;
break;
case 38:AST.reduce('symbol',1);
this.$ = $$[$0];
break;
case 39:AST.reduce('symbol',1);
this.$ = yytext;
break;
case 40:AST.reduce('id',1);
this.$ = yytext;
break;
case 41:AST.reduce('action',3);
this.$ = $$[$0-1];
break;
case 42:AST.reduce('action',1);
this.$ = $$[$0];
break;
case 43:AST.reduce('action',1);
this.$ = '$$ ='+$$[$0]+';';
break;
case 44:AST.reduce('action',0);
this.$ = '';
break;
case 45:AST.reduce('action_body',0);
this.$ = '';
break;
case 46:AST.reduce('action_body',1);
this.$ = yytext;
break;
case 47:AST.reduce('action_body',5);
this.$ = $$[$0-4]+$$[$0-3]+$$[$0-2]+$$[$0-1]+$$[$0];
break;
case 48:AST.reduce('action_body',4);
this.$ = $$[$0-3]+$$[$0-2]+$$[$0-1]+$$[$0];
break;
}
},
...
;
return lexer;})()
parser.lexer = lexer;rsymbols_=(function(list){	var rV=Object.create(null);	for(var i in list){		rV[list[i]]=i;	}	return rV;})(parser.symbols_);
return parser;
})();
